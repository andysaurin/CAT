...
{/if}
					...
					<div style="padding:20px;">
						...
						<div class="page-header">
							<h1 class="text">drosoCAT
								<small>
									<i class="icon-double-angle-right"></i>
									The <i><b>Droso</b>phila melanogaster</i> modENCODE <b>C</b>hIP <b>A</b>ssociation <b>T</b>ester
								</small>
							</h1>

							<span class="row">
								<p>
									drosoCAT allows you to easily compare your <i>Drosophila melanogaster</i> (dm3) ChIP peaks from your peak-called BED file with those from most all <i>D. melanogaster</i> <a href="http://www.modencode.org" title="modENCODE" target="_blank">modENCODE</a> ChIP peaks from cell lines and embryos (other tissues will be added as pre-computed data becomes available).
								</p>
								<p>
							...
							<div class="row">
								<h4 class="text blue lead">To use drosoCAT</h4>
								<ol>
									...
									<li><strong>Finally, you can simply obtain the association data selected, or upload your own <span class="red"><strong>dm3</strong></span>-mapped BED file(s).</strong></li>
								</ol>
							</div>
													...
													<div class="widget-box">
														<div class="widget-header">
															...
															<div class="widget-toolbar">
																<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="The number of modENCODE ChIP datasets available with pre-computed association data for each tissue is shown to the right of the tissue." title="Select a tissue (or tissues) of modENCODE datasets to use">?</span>
												...
												<div class="col-xs-12 col-sm-4" id="factorSelect" style="opacity:0.5">
													...
													<div class="widget-box">
														<div class="widget-header">
															...
															<div class="widget-toolbar">
																<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="The immunoprecipitated protein is selectable if there are pre-computed association data available for the selected tissue(s). The number of modENCODE ChIP datasets available with pre-computed association data will appear to the right the protein." title="Select the proteins you wish to study.">?</span>
																<a href="#" data-action="collapse">
																	<i class="icon-chevron-up"></i>
																</a>
															</div>
														...
														<div class="widget-body">
															<div class="widget-main" >
																...
																<div class="form-group row" id="increase_sensitivity_div">
																	...
																	<div class="col-xs-8">
																		<select class="col-xs-12" name="increase_sensitivity" class="form-control no-padding-right" id="increase_sensitivity" disabled>
																			<option value="hsp">Highly similar peaks</option>
																			{*<option value="zscore">Z-score</option>*}
																			<option value="op">Overlapping Peaks</option>
																		</select>
																	</div>
																...
																<div class="form-group row">
																	...
																	<div class="col-xs-1 no-padding-left">
																		<span  class="help-button param-help" style="display:none" data-rel="popover" data-trigger="hover" data-placement="left" title="Compare your data with modENCODE data?" data-content="If you simply want to view the pre-computed data, leave this option unchecked.<br>However, if you wish to include your own BED-formatted ChIP peaks or genomic regions in the analysis, check this option.">?</span>
																	</div>
																</div>
...
*}
																...
																<div class="form-group row">
																	<span class="col-xs-5 control-label no-padding-right" for="omitHOT"> Omit HOT regions?</span>
																	<div class="col-xs-2 no-padding-left">
																	...
																	<div class="col-xs-4">&nbsp;</div>
																	<div class="col-xs-1 no-padding-left">
																		<span  class="help-button param-help" style="display:none" data-rel="popover" data-trigger="hover" data-placement="left" data-html="true" title="Omit genomic regions considered as transcription factor (TF) <b>H</b>igh <b>O</b>ccupancy <b>T</b>argets." data-content="<p>Extensive overlap in the binding profiles of multiple TFs has revealed highly occupied target (HOT) regions or hotspots.</p><p>In studying TF colocalisation, you may wish to eliminate HOT regions that are known to bind more than 8 TFs by checking this option.</p><p>Checking this option will eliminate TF binding sites that overlap with HOT regions <strong>as well as</strong> any overlapping regions in user-submitted BED file. All non-TF ChIP profiles remain unaffected.</p>">?</span>
																	</div>
																</div>

																<div class="form-group row">
																	<span class="col-xs-4 no-padding-right">Omit certain datasets?</span>
																	<div class="col-xs-7 no-padding-left no-padding-right">
																		<input type="text" name="omit_factors" id="form-field-tags" placeholder="modENCODE IDs ..." class="col-xs-12" />

																	</div>
																	<div class="col-xs-1 no-padding-left">
																		<span  class="help-button param-help" style="display:none" data-rel="popover" data-trigger="hover" data-placement="left" title="Omit certain datasets." data-html="true" data-content="If you've previously run drosoCAT and found that multiple modENCODE replicates are biasing the clustering analysis, you can omit replicates by entering their modENCODE IDs here.<br><br>The modENCODE IDs are given in parentheses next to the protein name in the output heatmap.<br>Enter an ID number followed by return for each dataset to omit from the results.">?</span>
																	</div>
																</div>
			...
			{literal}
							...
							if(! ( /msie\s*(8|7|6)/.test(navigator.userAgent.toLowerCase())) )
							{
								...
								tag_input.after('<textarea cid="'+tag_input.attr('id')+'" name="'+tag_input.attr('name')+'" rows="3">'+tag_input.val()+'</textarea>').remove();
